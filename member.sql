...
CREATE TABLE `his_address` (
  ...
  `value` varchar(255) NOT NULL DEFAULT '' COMMENT '50',
  PRIMARY KEY (`id`)
...
CREATE TABLE `his_factor` (
  ...
  `appid` varchar(20) NOT NULL DEFAULT '' COMMENT '微信appid',
  `app_secret` varchar(32) NOT NULL DEFAULT '' COMMENT '微信appSercret',
  `mch_id` int(11) NOT NULL DEFAULT '0' COMMENT '微信商户id',
  `pay_key` varchar(32) NOT NULL DEFAULT '' COMMENT '微信支付key',
  `wechat_notify_url` varchar(255) NOT NULL DEFAULT '' COMMENT '微信回调地址',
  `ziwang_agent_id` int(11) NOT NULL DEFAULT '0' COMMENT '智网代理id',
  `ziwang_app_key` varchar(32) NOT NULL DEFAULT '' COMMENT '智网参数',
...
CREATE TABLE `his_order` (
  ...
  `iccid` varchar(30) NOT NULL DEFAULT '' COMMENT '下单iccid',
  `package_img_res` int(11) NOT NULL DEFAULT '0' COMMENT '头图id',
  `package_title` varchar(50) NOT NULL DEFAULT '' COMMENT '流量包名称',
  `package_detail` varchar(255) NOT NULL DEFAULT '' COMMENT '属性',
  ...
  `update_time` int(11) NOT NULL DEFAULT '0',
  `ext` varchar(10000) NOT NULL DEFAULT '' COMMENT '附加信息',
  `transaction_id` varchar(32) NOT NULL DEFAULT '' COMMENT '微信订单id',
...
CREATE TABLE `his_package` (
  ...
  `slide_list_res_id` varchar(20) NOT NULL DEFAULT '' COMMENT '轮播图ids json',
  `detail` text NOT NULL COMMENT '详情',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0-正常，1-禁用',
  `create_time` int(11) NOT NULL DEFAULT '0',
  `update_time` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unqi_package_id` (`package_id`)
...
CREATE TABLE `his_sms` (
  ...
  `biz_id` varchar(30) NOT NULL DEFAULT '' COMMENT '阿里回调',
  PRIMARY KEY (`id`),
  KEY `normal_phone` (`phone`)
...
CREATE TABLE `his_user_info` (
  ...
  `licenses_res` varchar(255) NOT NULL DEFAULT '' COMMENT '执照res的json',
...
CREATE TABLE `his_user_wechat` (
  `uid` int(11) NOT NULL,
  `province` varchar(30) NOT NULL DEFAULT '' COMMENT '用户个人资料填写的省份',
  `city` varchar(30) NOT NULL DEFAULT '' COMMENT '普通用户个人资料填写的城市',
  `country` varchar(20) NOT NULL DEFAULT '' COMMENT '国家，如中国为CN',
